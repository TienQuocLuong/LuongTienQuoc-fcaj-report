...
**Bước 9:** Chuyển sang phần **Environment variables** và thêm các khóa sau với giá trị tương ứng (Subnet, Security Group, tên Cluster...):
   ...
   - `TEST_HISTORY_TABLE`: `playwright-test-history`
![Biến môi trường Coordinator](/images/5-Workshop/5.7-lambda-functions/6-env-vars-coordinator.png)
...
![Trigger SQS cho Error Handler](/images/5-Workshop/5.7-lambda-functions/7-sqs-trigger-error-handler.png)

**Bước 6:** Chuyển sang phần **Environment variables** và thêm các biến sau:
   - `ERROR_DYNAMODB_TABLE`: `playwright-error-log`
   - `TEST_HISTORY_TABLE`: `playwright-test-history`
![Biến môi trường Error Handler](/images/5-Workshop/5.7-lambda-functions/8-env-vars-error-handler.png)
...
![Cấu hình VPC cho Postprocessing](/images/5-Workshop/5.7-lambda-functions/9-postprocessing-vpc.png)
...
**Bước 7:** Chọn **Environment variables** và nhấn **Edit**. Thêm các biến sau:
   ...
   - TEST_HISTORY_TABLE: playwright-test-history
![Biến môi trường Postprocessing](/images/5-Workshop/5.7-lambda-functions/10-postprocessing-env-vars.png)
