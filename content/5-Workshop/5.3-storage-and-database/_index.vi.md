...
![Tạo bảng playwright-email-config](/images/5-Workshop/5.3-Data-Storage/11-create-email-config-table.png?featherlight=false&width=90pc)
 
**Bước 11:** Bấm **Create table** lần thứ tư, đặt tên `playwright-test-suites`, Partition key = `suite_id`, kiểu **String**, bấm **Create table**.
 
![Tạo bảng playwright-test-suites](/images/5-Workshop/5.3-Data-Storage/12-create-test-suites-table.png?featherlight=false&width=90pc)
...
**Bước 13:** Mở **IAM Console**, tìm role `playwright-ecs-task-role`.
