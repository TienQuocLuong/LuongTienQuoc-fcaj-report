...
4. **Create S3:** Prepare buckets to store HTML reports and Frontend source code.
5. **Create ECR:** Repository for the system's Docker Images.

Let's start with the first step in the left menu!