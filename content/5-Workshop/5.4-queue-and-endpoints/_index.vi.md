...
![Tạo Dead Letter Queue](/images/5-Workshop/5.4-Queue-VPC-Endpoints/2-create-dlq.png?featherlight=false&width=90pc)
...
![Gắn Dead Letter Queue vào Task Queue](/images/5-Workshop/5.4-Queue-VPC-Endpoints/4-attach-dlq.png?featherlight=false&width=90pc)
...
![Tìm service ECR API](/images/5-Workshop/5.4-Queue-VPC-Endpoints/7-ecr-api-search.png?featherlight=false&width=90pc)
...
![Endpoint ECR API đã được tạo](/images/5-Workshop/5.4-Queue-VPC-Endpoints/8-ecr-api-created.png?featherlight=false&width=90pc)
...
![Tìm service ECR DKR](/images/5-Workshop/5.4-Queue-VPC-Endpoints/9-ecr-dkr-search.png?featherlight=false&width=90pc)
...
![Endpoint ECR DKR đã được tạo](/images/5-Workshop/5.4-Queue-VPC-Endpoints/10-ecr-dkr-created.png?featherlight=false&width=90pc)
...
![Tìm service CloudWatch Logs](/images/5-Workshop/5.4-Queue-VPC-Endpoints/11-logs-search.png?featherlight=false&width=90pc)
...
![Endpoint CloudWatch Logs đã được tạo](/images/5-Workshop/5.4-Queue-VPC-Endpoints/12-logs-created.png?featherlight=false&width=90pc)
...
![Kiểm tra available](/images/5-Workshop/5.4-Queue-VPC-Endpoints/16-available-check.png?featherlight=false&width=90pc)
...
![Route Table có route tới S3 Endpoint](/images/5-Workshop/5.4-Queue-VPC-Endpoints/17-route-table-check.png?featherlight=false&width=90pc)