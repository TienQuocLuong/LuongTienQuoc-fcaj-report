...
![Kiến trúc giải pháp tự động kiểm thử Playwright](/images/5-Workshop/5.1-Workshop-overview/diagram1.png)
...
4. Tóm tắt bằng AI: Lambda hậu kỳ tích hợp Secrets Manager cho khóa OpenAI API và cơ chế fallback dạng circuit-breaker.
