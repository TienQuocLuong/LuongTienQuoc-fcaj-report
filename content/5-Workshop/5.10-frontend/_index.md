...
![Open the CloudFront Console](/images/5-Workshop/5.10-frontend/4-cloudfront-console.png?featherlight=false&width=90pc)
...
![Select the Origin domain from the suggestion list](/images/5-Workshop/5.10-frontend/5-cloudfront-origin-domain.png?featherlight=false&width=90pc)
...
![Set the Default root object to index.html](/images/5-Workshop/5.10-frontend/6-cloudfront-default-root-object.png?featherlight=false&width=90pc)
...
![CloudFront Distribution created successfully](/images/5-Workshop/5.10-frontend/7-cloudfront-create-distribution.png?featherlight=false&width=90pc)
...
![Distribution Deploying, note down the Domain Name](/images/5-Workshop/5.10-frontend/8-cloudfront-deploying.png?featherlight=false&width=90pc)

**Step 8:** After creation, CloudFront shows a yellow banner: **"The S3 bucket policy needs to be updated"** → click **Copy policy**.

![Banner to update the S3 Bucket Policy](/images/5-Workshop/5.10-frontend/9-cloudfront-update-s3-policy.png?featherlight=false&width=90pc)
...
![Paste the policy into the S3 Bucket Policy](/images/5-Workshop/5.10-frontend/10-s3-bucket-policy-updated.png?featherlight=false&width=90pc)
...
![Update the Callback URL in the Cognito App Client](/images/5-Workshop/5.10-frontend/11-cognito-callback-url-updated.png?featherlight=false&width=90pc)
...
![Dashboard shows the correct login screen](/images/5-Workshop/5.10-frontend/12-cloudfront-dashboard-login.png?featherlight=false&width=90pc)
...
![Direct S3 access blocked with 403 Forbidden](/images/5-Workshop/5.10-frontend/13-s3-direct-403-forbidden.png?featherlight=false&width=90pc)
...
Next, we will move on to **[5.11. EventBridge](../5.11-eventbridge/)** to configure the trigger for automated report processing.
