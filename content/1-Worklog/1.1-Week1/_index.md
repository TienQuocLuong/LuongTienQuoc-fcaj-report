...
### Week 1 Objectives:
Attend the opening ceremony, create an AWS account, get familiar with Module 01 (cloud fundamentals, IAM, cost management), and join the project team.
...
* Successfully created an AWS account, enabled MFA on the root account, and configured basic permission groups (Admin, User) in IAM.
* Learned how to set up budgets and cost alerts to control the Free Tier account.
* Understood the foundational concepts of cloud computing and the shared responsibility model.
* Officially joined the team and began shaping my role in the project.